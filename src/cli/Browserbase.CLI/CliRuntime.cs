...
namespace Browserbase.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Browserbase.CLI";
    private const string UserSecretApiKeyName = "BROWSERBASE_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BROWSERBASE_API_KEY"];
    private const string CredentialFileDirectoryName = ".browserbase";

    public static async global::System.Threading.Tasks.Task<global::Browserbase.BrowserbaseClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Browserbase.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Browserbase.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Browserbase.BrowserbaseClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Browserbase.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Browserbase.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Browserbase.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Browserbase.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BROWSERBASE_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Browserbase.ApiException exception)
    {
        var builder = new StringBuilder();
