...
namespace Browserbase
{
    public partial class BrowserbaseClient
    {
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement s_AgentRunsStopSecurityRequirement0 =
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement[] s_AgentRunsStopSecurityRequirements =
            new global::Browserbase.EndPointSecurityRequirement[]
            {                s_AgentRunsStopSecurityRequirement0,
            };
        partial void PrepareAgentRunsStopArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId);
        partial void PrepareAgentRunsStopRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId);
        partial void ProcessAgentRunsStopResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentRunsStopResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await AgentRunsStopAsResponseAsync(
                runId: runId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Browserbase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentRunsStopSecurityRequirements,
                operationName: "AgentRunsStopAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Browserbase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentRunsStop",
                                methodName: "AgentRunsStopAsync",
                                pathTemplate: "$\"/v1/agents/runs/{runId}/stop\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentRunsStopResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
