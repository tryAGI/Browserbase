...
namespace Browserbase
{
    public partial class BrowserbaseClient
    {
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement s_AgentRunsMessagesSecurityRequirement0 =
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement[] s_AgentRunsMessagesSecurityRequirements =
            new global::Browserbase.EndPointSecurityRequirement[]
            {                s_AgentRunsMessagesSecurityRequirement0,
            };
        partial void PrepareAgentRunsMessagesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? since,
            ref int? limit,
            ref bool? all,
            ref global::System.Guid runId);
        partial void PrepareAgentRunsMessagesRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessAgentRunsMessagesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentRunsMessagesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await AgentRunsMessagesAsResponseAsync(
                runId: runId,
                since: since,
                limit: limit,
                all: all,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentRunsMessagesArguments(
            ...
            var __authorizations = global::Browserbase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentRunsMessagesSecurityRequirements,
                operationName: "AgentRunsMessagesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentRunsMessagesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentRunsMessagesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentRunsMessagesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Browserbase.AgentRunsMessagesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Browserbase.AutoSDKHttpResponse<global::Browserbase.AgentRunsMessagesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Browserbase.AgentRunsMessagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
