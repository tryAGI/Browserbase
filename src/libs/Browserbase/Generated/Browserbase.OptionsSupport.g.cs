...
namespace Browserbase
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Browserbase.AutoSDKRetryOptions Retry { get; set; } = new global::Browserbase.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Browserbase.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Browserbase.IAutoSDKHook>();
        ...
        public global::Browserbase.AutoSDKClientOptions AddHook(
            global::Browserbase.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Browserbase.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Browserbase.AutoSDKClientOptions UseAuthorizationProvider(
            global::Browserbase.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Browserbase.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Browserbase.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Browserbase.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Browserbase.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Browserbase.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Browserbase.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Browserbase.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Browserbase.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Browserbase.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Browserbase.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Browserbase.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Browserbase.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Browserbase.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Browserbase.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Browserbase.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Browserbase.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Browserbase.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Browserbase.IAutoSDKHook, global::Browserbase.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Browserbase.AutoSDKHookContext context)
        {
