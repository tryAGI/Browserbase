...
namespace Browserbase
{
    public partial class BrowserbaseClient
    {
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement s_AgentRunsGetSecurityRequirement0 =
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement[] s_AgentRunsGetSecurityRequirements =
            new global::Browserbase.EndPointSecurityRequirement[]
            {                s_AgentRunsGetSecurityRequirement0,
            };
        partial void PrepareAgentRunsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId);
        partial void PrepareAgentRunsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId);
        partial void ProcessAgentRunsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentRunsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await AgentRunsGetAsResponseAsync(
                runId: runId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Browserbase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentRunsGetSecurityRequirements,
                operationName: "AgentRunsGetAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Browserbase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentRunsGet",
                                methodName: "AgentRunsGetAsync",
                ...
                else
                {
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentRunsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
