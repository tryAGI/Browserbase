...
namespace Browserbase
{
    public partial class BrowserbaseClient
    {
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement s_WebhooksRotateSecretSecurityRequirement0 =
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement[] s_WebhooksRotateSecretSecurityRequirements =
            new global::Browserbase.EndPointSecurityRequirement[]
            {                s_WebhooksRotateSecretSecurityRequirement0,
            };
        partial void PrepareWebhooksRotateSecretArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            global::Browserbase.WebhooksRotateSecretRequest request);
        partial void PrepareWebhooksRotateSecretRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            global::Browserbase.WebhooksRotateSecretRequest request);
        partial void ProcessWebhooksRotateSecretResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhooksRotateSecretResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// console.log(secret);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Browserbase.WebhooksRotateSecretResponse> WebhooksRotateSecretAsync(
            global::System.Guid id,
        ...
        {
            var __response = await WebhooksRotateSecretAsResponseAsync(
                id: id,
        ...
        /// console.log(secret);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Browserbase.AutoSDKHttpResponse<global::Browserbase.WebhooksRotateSecretResponse>> WebhooksRotateSecretAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksRotateSecretArguments(
            ...
            var __authorizations = global::Browserbase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksRotateSecretSecurityRequirements,
                operationName: "WebhooksRotateSecretAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhooksRotateSecretRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Browserbase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "WebhooksRotateSecretAsync",
                                pathTemplate: "$\"/v1/webhooks/{id}/secret\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhooksRotateSecretResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksRotateSecretResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Browserbase.WebhooksRotateSecretResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Browserbase.AutoSDKHttpResponse<global::Browserbase.WebhooksRotateSecretResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Browserbase.WebhooksRotateSecretResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Browserbase.WebhooksRotateSecretResponse> WebhooksRotateSecretAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Browserbase.WebhooksRotateSecretRequest
            {
                RevokeImmediately = revokeImmediately,
            };

            return await WebhooksRotateSecretAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
