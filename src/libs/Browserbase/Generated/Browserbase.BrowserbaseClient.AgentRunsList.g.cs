...
namespace Browserbase
{
    public partial class BrowserbaseClient
    {
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement s_AgentRunsListSecurityRequirement0 =
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement[] s_AgentRunsListSecurityRequirements =
            new global::Browserbase.EndPointSecurityRequirement[]
            {                s_AgentRunsListSecurityRequirement0,
            };
        partial void PrepareAgentRunsListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Browserbase.AgentRunsListStatus? status,
            ref string? agentId,
            ref global::System.DateTime? startAt,
            ref global::System.DateTime? endAt,
            ref int? limit,
            ref string? cursor);
        partial void PrepareAgentRunsListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Browserbase.AgentRunsListStatus? status,
            string? agentId,
            global::System.DateTime? startAt,
            global::System.DateTime? endAt,
            int? limit,
            string? cursor);
        partial void ProcessAgentRunsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentRunsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await AgentRunsListAsResponseAsync(
                status: status,
                agentId: agentId,
                startAt: startAt,
                endAt: endAt,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Browserbase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentRunsListSecurityRequirements,
                operationName: "AgentRunsListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("startAt", startAt?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                                .AddOptionalParameter("endAt", endAt?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Browserbase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentRunsList",
                                methodName: "AgentRunsListAsync",
                ...
                else
                {
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentRunsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Browserbase.AgentRunsListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Browserbase.AutoSDKHttpResponse<global::Browserbase.AgentRunsListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Browserbase.AgentRunsListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
