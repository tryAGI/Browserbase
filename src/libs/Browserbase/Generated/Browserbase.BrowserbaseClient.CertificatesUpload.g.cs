...
namespace Browserbase
{
    public partial class BrowserbaseClient
    {
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement s_CertificatesUploadSecurityRequirement0 =
        ...
        private static readonly global::Browserbase.EndPointSecurityRequirement[] s_CertificatesUploadSecurityRequirements =
            new global::Browserbase.EndPointSecurityRequirement[]
            {                s_CertificatesUploadSecurityRequirement0,
            };
        partial void PrepareCertificatesUploadArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Browserbase.CertificatesUploadRequest request);
        partial void PrepareCertificatesUploadRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Browserbase.CertificatesUploadRequest request);
        partial void ProcessCertificatesUploadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCertificatesUploadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Browserbase.Certificate> CertificatesUploadAsync(

            global::Browserbase.CertificatesUploadRequest request,
            global::Browserbase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CertificatesUploadAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Browserbase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Browserbase.AutoSDKHttpResponse<global::Browserbase.Certificate>> CertificatesUploadAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCertificatesUploadArguments(
            ...
            var __authorizations = global::Browserbase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CertificatesUploadSecurityRequirements,
                operationName: "CertificatesUploadAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCertificatesUploadRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Browserbase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CertificatesUploadAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCertificatesUploadResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCertificatesUploadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Browserbase.Certificate.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Browserbase.AutoSDKHttpResponse<global::Browserbase.Certificate>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Browserbase.Certificate.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Browserbase.Certificate> CertificatesUploadAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Browserbase.CertificatesUploadRequest
            {
                File = file,
                Filename = filename,
            };

            return await CertificatesUploadAsync(
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Browserbase.CertificatesUploadRequest
            {
                    ...
                    await global::Browserbase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Browserbase.Certificate.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Browserbase.Certificate.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
